    ...
    <footer className="hidden md:block bg-[#FBF7F6] text-[#4b4845] text-sm py-14 px-20">
      <div className="grid grid-cols-4 gap-10 max-w-screen-xl mx-auto">
        ...
        <div className="space-y-4">
          <h3 className={`text-lg md:text-xl font-light ${styles.logo}`}>
            BEAUTY HANDS
          </h3>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1">
            <li><Link href="/" className="hover:text-[#FFC5B8] transition">О нас</Link></li>
            <li><Link href="/" className="hover:text-[#FFC5B8] transition">Услуги</Link></li>
            <li><Link href="/" className="hover:text-[#FFC5B8] transition">Прайс-лист</Link></li>
            <li><Link href="/" className="hover:text-[#FFC5B8] transition">Партнеры</Link></li>
            <li><Link href="/" className="hover:text-[#FFC5B8] transition">Акции</Link></li>
            <li><Link href="/" className="hover:text-[#FFC5B8] transition">Портфолио работ</Link></li>
          </ul>
        </div>
