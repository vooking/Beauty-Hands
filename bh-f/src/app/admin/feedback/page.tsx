...
const FeedbackListItem = memo(({ item, onDelete }: { item: FeedbackItem; onDelete: (id: number) => void }) => (
  <li className="bg-white border-l-4 border-[#4b4845] p-4 sm:p-6 rounded-xl shadow-sm hover:shadow-md transition">
